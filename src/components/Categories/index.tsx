...
export default function Categories({ categories }: { categories: PaginatedDocs<Category> }) {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="grid grid-cols-1 items-center justify-items-center md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 lg:gap-10 gap-y-24 md:gap-y-24 lg:gap-y-36 pb-8 md:pt-28 sm:px-6 md:px-8 lg:px-32 xl:px-32 w-full"

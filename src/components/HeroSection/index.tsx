    ...
    <>
      ...
      <section className="relative" aria-label="Hero section - White Trading Company introduction">
        ...
        <div className="sm:hidden m-4 relative">
          <div className="relative w-full h-[314px] sm:h-[280px] md:h-[50vh] overflow-hidden rounded-2xl">
          ...
          <div className="flex flex-col absolute top-0 left-0 xs:items-end justify-start z-[3] xs:mt-[162px] mt-[130px] pointer-events-none">
            <div
